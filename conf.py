...
BLOG_AUTHOR = "Jeremiah Paige"  # (translatable)
BLOG_TITLE = "µCodery"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://blog.ucodery.com/"
BLOG_EMAIL = "ucodery@gmail.com"
BLOG_DESCRIPTION = "one coder's distillation of thought"  # (translatable)
DEFAULT_LANG = "en"
...
CODE_COLOR_SCHEME = 'witchhazel'

# FAVICONS contains (name, file, size) tuples.
# Used to create favicon link like this:
# <link rel="name" href="file" sizes="size"/>
FAVICONS = (
    ("apple-touch-icon", "/images/apple-touch-icon.png", "180x180"),
...
# is in the manual.
COMMENT_SYSTEM_ID = "ucodery/ucodery-blog"
...
GLOBAL_CONTEXT = {
    'utterances_config': {
        ...
        'label': 'Comments',
        'theme': 'icy-dark'},
    'TWITTER_URL': 'https://twitter.com/ucodery',
    'GITHUB_URL': 'https://github.com/ucodery',
    'LINKEDIN_URL': None,
    'BANNER_URL': '/images/cityscape.jpg'
}
